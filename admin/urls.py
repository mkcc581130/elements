...
urlpatterns = [
    ...
    re_path('^ele_object_list/$', admin_views.ele_object_list, name='ele_object_list'),
    re_path('^ele_object_list/(edit|add)+/$', admin_views.ele_object_mod, name='ele_object_mod'),
    ...
    re_path('^ele_family_list/$', admin_views.ele_family_list, name='ele_family_list'),
    re_path('^ele_family_list/(edit|add)+/$', admin_views.ele_family_mod, name='ele_family_mod'),
    ...
    re_path('^ele_periodic_img_list/$', admin_views.ele_periodic_img_list, name='ele_periodic_img_list'),
    re_path('^ele_periodic_img_list/(edit|add)+/$', admin_views.ele_periodic_img_mod, name='ele_periodic_img_mod'),
]
