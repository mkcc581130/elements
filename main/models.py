...
class Elements(models.Model):
    ...
    atomic_radius = models.CharField(max_length=100, verbose_name="原子半径")
    electronegativity = models.DecimalField(default=0.00, max_digits=6, decimal_places=2, verbose_name="电负性")
